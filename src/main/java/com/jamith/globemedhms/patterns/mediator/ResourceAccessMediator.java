package com.jamith.globemedhms.patterns.mediator;
...
public class ResourceAccessMediator {
    private static final Logger logger = LogManager.getLogger(ResourceAccessMediator.class);
